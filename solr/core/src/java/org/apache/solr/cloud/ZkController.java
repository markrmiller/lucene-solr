...
//  
 ...
 // nocommit
      closer.add("Cleanup&Terms&RepFromLeaders", solrSeer, removeEphem, publishDown, collectionToTerms, replicateFromLeaders);
      closer.add("ZkController Internals", overseerElector.getContext(), electionContexts, overseer,
