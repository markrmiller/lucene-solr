...
public class BasicAuthOnSingleNodeTest extends SolrCloudAuthTestCase {
  ...
  @BeforeClass
  public static void beforeBasicAuthOnSingleNodeTest() throws Exception {
  ...
  public void basicTest() throws Exception {
    try (Http2SolrClient client = new Http2SolrClient.Builder(cluster.getJettySolrRunner(0).getBaseUrl().toString())
        .build()){
      try (PreemptiveBasicAuthClientBuilderFactory factory = new PreemptiveBasicAuthClientBuilderFactory()) {
