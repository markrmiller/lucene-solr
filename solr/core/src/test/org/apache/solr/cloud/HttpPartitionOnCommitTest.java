...
//
//  private static final long sleepMsBeforeHealPartition = TEST_NIGHTLY ? 2000L : 500L;
//
...
//    super();
//    sliceCount = 1;
//    fixShardCount(TEST_NIGHTLY ? 4 : 3);
//  }
//
//  @Override
...
//    oneShardTest();
//    if (TEST_NIGHTLY) multiShardTest();
//  }
//
...
//    createCollection(testCollectionName, "conf1", 2, 2, 10);
