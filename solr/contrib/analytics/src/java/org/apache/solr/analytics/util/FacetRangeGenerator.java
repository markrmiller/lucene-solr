...
public abstract class FacetRangeGenerator<T extends Comparable<T>> {
  ...
  public final T getValue(final String rawval) {
    try {
      ...
      throw new SW.Exp("Can't parse value "+rawval+" for field: " + field.getName(), e);
    }
  }
  ...
  public final Object getGap(final String gap) {
    try {
      ...
      throw new SW.Exp("Can't parse gap "+gap+" for field: " + field.getName(), e);
    }
  }
  ...
  public final T addGap(T value, String gap) {
    try {
      ...
      throw new SW.Exp("Can't add gap "+gap+" to value " + value + " for field: " + field.getName(), e);
    }
  }
